...
if not creds_json:
    ...
    try:
        ...
        datas = ['18/11/2024', '19/11/2024', '20/11/2024', '21/11/2024', '22/11/2024',]
        horarios_por_data = {
            '18/11/2024': ['13h30', '14h00', '14h30', '15h00', '15h30', '16h00', '16h30', '17h00'],
            '19/11/2024': ['13h30', '14h00', '14h30', '15h00', '15h30', '16h00', '16h30', '17h00'],
            '20/11/2024': ['13h30', '14h00', '14h30', '15h00', '15h30', '16h00', '16h30', '17h00'],
            '21/11/2024': ['13h30', '14h00', '14h30', '15h00', '15h30', '16h00', '16h30', '17h00'],
            '22/11/2024': ['13h30', '14h00', '14h30', '15h00', '15h30', '16h00', '16h30', '17h00'],
        }
        ...
        # Separação visual da parte de consulta
        st.markdown("---")  # Linha para separar as seções

        # Caixa de consulta mais suave
        st.markdown(
            """
            <div style="background-color: #f9f9f9; padding: 2px; border-radius: 2px; border: 1px solid #e0e0e0; margin-top: 2px;">

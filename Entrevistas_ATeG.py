...
st.markdown(
    """
    <style>
        /* Define o fundo da página como verde */
        .main {
            background-color: #235937;
        }
    </style>

    <!-- Bloco superior com título e logo -->
    ...
    <!-- Novo bloco para os campos de entrada -->
    <div style="background-color: white; padding: 20px; border-radius: 8px; box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.1); width: 60%; margin: auto; margin-top: 40px; padding-top: 30px; padding-bottom: 30px;">
        <!-- Aqui dentro você pode adicionar os campos de formulário do Streamlit -->
    </div>
    """,

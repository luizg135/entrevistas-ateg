...
#         # Formulário de agendamento com * nos campos obrigatórios
...
#         # Filtrar horários disponíveis para a data selecionada com base no dicionário
...
#         # Exibir mensagem de campos obrigatórios
#         st.markdown("<p style='color: red; font-size: 12px;'>* Campos de preenchimento obrigatório</p>", unsafe_allow_html=True)
...
def validar_nome(nome):
    # Regex: ao menos 3 letras com espaço, aceitando acentos
